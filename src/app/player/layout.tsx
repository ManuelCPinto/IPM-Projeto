...
const Layout: React.FC<LayoutProps> = ({ children }) => (
  <div className="grid h-screen grid-rows-[max-content_1fr_max-content] grid-cols-[max-content_1fr] gap-0">
    ...
    <Sidebar />
    {/* Content Area */}
    <main className="grid overflow-y-auto bg-neutral-900 bg-[radial-gradient(ellipse_75%_75%_at_50%_50%,rgba(30,30,50,0.6),rgba(15,15,30,1),rgba(5,5,15,1))] shadow-lg">
      {children}
    </main>
    {/* Music Player */}
