  ...
  return (
    <div className="bg-gray-900 rounded-lg shadow-lg p-6 max-h-[800px] space-y-6">
      ...
      <div className="space-y-4">
        {Albums.map((album) => (
          <div key={album.albumId} className="flex items-start gap-4 hover:bg-gray-700 p-4 rounded-lg transition">
            {/* Album Cover */}
            <Image
              src={album.cover}
            ...
            <div className="flex-1">
              <Link href={`/player/ratings/albums/${album.albumId}`}>
                <h3 className="text-white font-semibold text-lg hover:underline cursor-pointer">{album.name}</h3>
              </Link>
